...
//
    try {
        ...
        cout << "Illegal coordinate: " << ex.what() << endl;  // prints "Illegal coordinate: 3,4"
    }
    ...
    try {
        ...
        cout << "Illegal char: " << ex.what() << endl;  // "Illegal char: a"
    }

    try {
        board1[{0,1}] = 'x';  // This should raise an exception
    } catch (const IllegalCharException& ex) {
        cout << "Illegal char: " << ex.what() << endl;  // "Illegal char: x"
    }
